...
<html>
	<head>
		<meta charset="utf-8">
		<link href="/MeiZu-SunShine/Public/Home/css/video.css" type="text/css" rel="Stylesheet"/>
		<script src="/MeiZu-SunShine/Public/Home/js/jquery-1.8.3.min.js"></script>
	</head>
	<body>
		<div class="main">
			<div class="top">
				<div class="img">
					<img src="/MeiZu-SunShine/Public/Home/images/index.jpg" width="120px" height="120px">
				</div>
				<div class="font">
					魅族科技
				</div>
				...
				<?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="film" style="float:left;">
					...
					<div class="movie">	
						<video controls width="300px" height="300px">
							<source src="/MeiZu-SunShine/Public/<?php echo ($vo['src']); ?>" type="video/webm"/>
						</video>
					</div>	
						...
						if(dHeight-sHeight-wHeight<50){
							$.get('<?php echo U('Video/ajax');?>',function(msg){
								...
								for (var i in msg){
									...
									str+='<source src="/MeiZu-SunShine/Public/'+msg[i]['src']+'" type="video/mp4">';
									str+='</video>';
									str+='</div>';
								}
								console.log(str);
