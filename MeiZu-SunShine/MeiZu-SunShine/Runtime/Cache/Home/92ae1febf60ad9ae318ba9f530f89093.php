...
<html>
	<head>
		<meta charset="utf-8">
		<link href="/MeiZu-SunShine/Public/home/css/reply.css" type="text/css" rel="Stylesheet">
		<script src="/MeiZu-SunShine/Public/Home/js/jquery-1.11.3.min.js"></script>
		<!-- 引入百度编辑器的js文件 -->
		<script src="/MeiZu-SunShine/Public/UEditor/ueditor.config.js"></script>
		<script src="/MeiZu-SunShine/Public/UEditor/ueditor.all.min.js"></script>
	...
	<body>
		<div class="total">
			<div class="top">
				<div class="left">
					<a href='<?php echo U("Index/index");?>'><img src="/MeiZu-SunShine/Public/Home/images/logo.png">
				</div>
				<div class="right">
					<span>
			...
			<div class="main">
				...
				<div class="message">
					<div class="img">
						<img src="/MeiZu-SunShine/Public/<?php echo empty($data['photo'])?'default.jpg':$data['photo'];?>" width="100px" height="100px">
					</div>
					<div class="title">
					...
					<div style="position:relative;left:600px;top:40px">
						<a href="javascript:void(0)"><img src="/MeiZu-SunShine/Public/Home/images/like.jpg"  width="30px" height="30px" id="like"></a><span>+<?php echo ($data['like']); ?></span>
					</div>
				</div>
				<form>
				...
				<div class="replay">
					...
					<?php if(is_array($data1)): $k = 0; $__LIST__ = $data1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="repCon">
						<div class="img">
							<img src="/MeiZu-SunShine/Public/<?php echo empty($vo['photo'])?'default.jpg':$vo['photo'];?>" width="100px" height="100px">
						</div>
						<div class="username">
						...
						<div style="position:relative;left:500px;top:70px">
							<a href="javascript:void(0)"><img src="/MeiZu-SunShine/Public/Home/images/like.jpg"  width="30px" height="30px" id="Img<?php echo ($vo['id']); ?>"></a><span>+<?php echo ($vo['like']); ?></span>
						</div>
