...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link href="/MeiZu-SunShine/Public/Home/css/style_1_common.css" rel="stylesheet">
    <link href="/MeiZu-SunShine/Public/Home/css/common.css" rel="stylesheet">
    <link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/lottery.css">
	<link style="" id="layui_layer_skinlayercss" href="/MeiZu-SunShine/Public/Home/css/layer.css" rel="stylesheet"></head>
	<link href="/MeiZu-SunShine/Public/Home/css/draw.css" type="text/css" rel="Stylesheet">
	<script type="text/javascript" src="/MeiZu-SunShine/Public/Home/js/jquery-1.11.3.min.js"></script>
	<script type="text/javascript" src="/MeiZu-SunShine/Public/Home/js/jquery.rotate.min.js"></script>
	<script src="/MeiZu-SunShine/Public/Home/js/xcConfirm.js"></script>
		<link href="/MeiZu-SunShine/Public/Home/css/xcConfirm.css" type="text/css" rel="Stylesheet"/>
                            ...
                            <div class="login-box" id="mzCust" attribute="1" rel="&lt;!--{eval echo empty($is_index) ? '' : 1;}--&gt;">
                                <div style="position: relative;" class="loginArea">
                                    ...
                                    <div class="log-img-box">
                                        <img src="/MeiZu-SunShine/PublicHome/images/log-default-avatar.png" alt="log" class="user-avatar">
                                        <img class="arrow" src="/MeiZu-SunShine/Public/Home/images/log-arrow.png">
...
<div id="wp" class="wp">
    <div class="draw_container cl">
        <div class="draw_area fll">
            <div class="draw_cont">
                <div class="pointer">
                    <img src="/MeiZu-SunShine/Public/Home/images/pointer.png" alt="pointer" id="pointer">
                </div>
                <div class="rotate">
                    <img id="rotate" src="/MeiZu-SunShine/Public/Home/images/turnplate.png" alt="turnplate">
                </div>
            </div>
            <div class="draw_rule">
                <h2>抽奖规则</h2>
        ...
        <div class="info_area fll cl">
            ...
            <div class="line"></div>
                ...
                <img src="/MeiZu-SunShine/Public/Home/images/114910d2v5eybybbv55zvf.jpg" alt="嘘，魅族社区APP低调测试中…" width="290">
            </a>
            <div class="line"></div>
...
<input id="getinfo_id" value="0" type="hidden">
        ...
        <div id="Footer" class="cl">
            <div id="footer1">
                ...
                <img class="footline" src="/MeiZu-SunShine/Public/Home/images/space.gif">
                ...
                <img src="/MeiZu-SunShine/Public/Home/images/earth.jpg">简体中文&nbsp;&nbsp;</a>
            ...
            <div id="footer2" class="copyright">
                ...
                <span id="footcap">
                    ...
                    <img class="cap1" src="/MeiZu-SunShine/Public/Home/images/space.gif" border="0">
                    </a>
                    <a target="_blank" rel="nofollow" href="http://210.76.65.188/webrecord/innernet/Welcome.jsp?bano=4404013010531">
                    <img class="cap2" src="/MeiZu-SunShine/Public/Home/images/space.gif" border="0">
                    </a>
                                                        </span>
            </div>
        </div>
