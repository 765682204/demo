<?php if (!defined('THINK_PATH')) exit();?>		<!-- 引入头部 -->
		...
		<div class="container main">
			...
			<?php if(is_array($banner)): foreach($banner as $key=>$vo0): ?><a href="">
					<img id='img' src="/MeiZu-SunShine/Public/<?php echo ($vo0['src']); ?>" alt="" style="display:none">
			...
			<div class="container ready">
				<div class="row ready_1">
					...
					<a href=""><div class="ready_2"><img src="/MeiZu-SunShine/Public/Home/images/y1.jpg" alt=""></div></a>
					<a href=""><div class="ready_2"><img src="/MeiZu-SunShine/Public/Home/images/y2.jpg" alt=""></div></a>
					<a href=""><div class="ready_2"><img src="/MeiZu-SunShine/Public/Home/images/y3.jpg" alt=""></div></a>
					<a href=""><div class="ready_2"><img src="/MeiZu-SunShine/Public/Home/images/y4.png" alt=""></div></a>
				</div>
			</div>
			...
			<div class="container">
				<div class="row hot">
					<div class="row hot_1">
						...
						<div class="hot_3">
							<a href="javascript:void(0)"  id='left'><div><img src="/MeiZu-SunShine/Public/Home/images/arrow-r.png" alt=""></div></a>
							<a href="javascript:void(0)"  id='right'><div style="margin-right:10px"><img src="/MeiZu-SunShine/Public/Home/images/arrow-l.png" alt=""></div></a>
						</div>
					</div>
					<div class="row2">
						<div class="row hot_4">
							<a href="" class="hot_5 hot_6"><img src="/MeiZu-SunShine/Public/Home/images/hot1.jpg" alt=""></a>
				...
				<div class="row phone">
					<div class="row hot_1">
						...
						<div class="hot_3">
							<a href="javascript:void(0)"  id='left'>
								<div id="more"><span>更多</span><img src="/MeiZu-SunShine/Public/Home/images/pkg-home_z.png" alt=""></div>
							</a>
					...
					<div class="row2 row2_1">
						<div class="row hot_4_1 phone_1">
							<!-- <a href="" class="hot_5 hot_6 hot_6_2"><img src="/MeiZu-SunShine/Public/Home/images/<?php echo ($img[image]); ?>" alt=""></a> -->
							<!-- 开始遍历 -->
							<?php if(is_array($vo5)): foreach($vo5 as $key=>$vo6): ?><a href="" class="hot_5">
							
								<div class="hot_5_1">
								<div class="stat"><?php echo ($vo6['hot']); ?></div>
									<img src="/MeiZu-SunShine/Public/<?php echo ($vo6['pic']); ?>" alt="">
								</div>
								<div class="hot_7">
