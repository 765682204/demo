<?php if (!defined('THINK_PATH')) exit();?>		<!-- 引入头部 -->
	...
	<!--购物车top-->
	<div class="store_top">
		<img src="/MeiZu-SunShine/Public/Home/images/liu.gif" alt="">
	</div>
	...
	<div class="store_center1">
		<table class="table">
			...
			<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class='shangpin'>
						...
						<td>
							<div class="goods">
								<div class="pic"><img src="/MeiZu-SunShine/Public/<?php echo ($vo['pic']); ?>" alt=""></div>
								<div class="texts">
		...
		<div height='140px' id='empty'>
			<div>
				<img src="/MeiZu-SunShine/Public/Home/images/002.gif" alt="">
