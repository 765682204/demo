	...
	<div class="container detail_2">
		<div class="row det_2">
			<div class="col-md-6 det_2_1">
				<a href="">
					 <img src="/MeiZu-SunShine/Public/<?php echo ($img['pic1']); ?>" alt="" id="detimg" style="display: block;">
				</a>
				<div class="minpic" style="block">
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/<?php echo ($img['pic1']); ?>" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/<?php echo ($img['pic2']); ?>" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/<?php echo ($img['pic3']); ?>" alt=""></a>
				</div>
				<div class="minpic" style="display:none">
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/pro5_1.jpg" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/pro5_2.jpg" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/pro5_3.jpg" alt=""></a>
				</div>
				<div class="minpic" style="display:none">
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/bai1.jpg" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/bai2.jpg" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/bai3.jpg" alt=""></a>
				</div>
				<div class="minpic" style="display:none">
					<a href="javascript:;"><img  src="/MeiZu-SunShine/Public/Home/images/pro5_1.jpg" alt=""></a>
					<a href="javascript:;"><img src="/MeiZu-SunShine/Public/Home/images/pro5_2.jpg" alt=""></a>
			...
			<div class="col-md-6 det_2_2">
				...
				<div class="det_4 det_4_1">
                    ...
                    <?php if(is_array($data2)): foreach($data2 as $key=>$vo2): ?><a href='javascript:;' class="liantong yin" bgcolor='#FFF'>
							<img src="/MeiZu-SunShine/Public/Home/images/yin.png" alt="" class="color">
	...
	<div class="container">
		...
		<div class="x" style="height:700px;font-size:26px;display: none">
			...
			<?php if(is_array($vo1)): foreach($vo1 as $key=>$vo1): ?><div style="border:1px solid #999999;height:300px">	
				<div style="width:100px;float:left;height:200px"><img src="/MeiZu-SunShine/Public/<?php echo empty($vo1['plphoto'])? 'default.jpg' : $vo1['plphoto'];?>" alt="" width="80" height="80"></div>
