...
<html>
	<head>
		<meta charset="utf-8"/>
		<link href="/MeiZu-SunShine/Public/Home/css/post.css" type="text/css" rel="Stylesheet"/>
	...
	<body>
		...
		<?php if(is_array($data)): foreach($data as $k=>$vo): ?><div class="block">
			<div class="hotPost">
				<img src="/MeiZu-SunShine/Public/<?php echo empty($vo['photo'])?'default.jpg':$vo['photo'];?>" width="50px" height="50px">
			</div>
			<div class="content">
			...
			<div class="top">
				<?php if($vo['top'] == 2): ?><img src="/MeiZu-SunShine/Public/Home/images/top.gif" width="25px" height="25px">
				<?php else: ?>
			...
			<div class="add">
				<?php if($vo['add'] == 2): ?><img src="/MeiZu-SunShine/Public/Home/images/add.gif" width="25px" height="25px">
				<?php else: ?>
				<div style="width:25px;height:25px;">
				</div><?php endif; ?>
			</div>
		...
		<div class="editor">		
			<form action="<?php echo U('Post/add');?>" method="post">
				...
				<input type='image' value='提交' src="/MeiZu-SunShine/Public/Home/images/timg.jpg" class="submit"/>	
			</form>	
		</div>	
		<!--<script>
