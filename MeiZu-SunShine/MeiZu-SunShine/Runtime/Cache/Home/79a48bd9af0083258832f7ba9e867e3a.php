...
<html>
	<head>
		<meta charset="utf-8">
		<link href="/MeiZu-SunShine/Public/Home/css/client.css" type="text/css" rel="Stylesheet"/>
		...
		<link href="/MeiZu-SunShine/Public/Home/css/theme.css" rel="stylesheet" media="all">
	</head>
	<body>
		<div class="main">
			<div class="head">
			...
			<div class="content">
				<div class="content_one">
					<div class="img">
						<img src="/MeiZu-SunShine/Public/<?php echo empty($data['photo']) ? 'default.jpg' : $data['photo'];?>" width="100px" height="100px"><br>
