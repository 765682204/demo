...
<head>
	...
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/bootstrap.min.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/header.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/footer.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/type.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/main.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/detail.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/store.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/order.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/shop3.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/pj.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/question.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/qreply.css">
	<link rel="stylesheet" href="/MeiZu-SunShine/Public/Home/css/meiball.css">
				...
				<div class="row nav_2">
					<div class="col-md-2">
						<a href="<?php echo U('Index/index');?>">
							<img src="/MeiZu-SunShine/Public/<?php echo ($logo['logo']); ?>" alt="LOGO" width="115px" height="20px">
						</a>
					</div>
			...
			<div class="container">
				<div class="row hidden">
					<?php if(is_array($pro)): foreach($pro as $key=>$vo1): ?><div class="col-md-2 slide_1">
						<a href="<?php echo U('Detail/detail');?>?id=<?php echo ($vo1['id']); ?>">
							<div class="slide_2">
								<img src="/MeiZu-SunShine/Public/<?php echo ($vo1['pic']); ?>" alt="">
				...
				<div class="row hidden">
					<?php if(is_array($meilan)): foreach($meilan as $key=>$vo2): ?><div class="col-md-2 slide_1">
						<a href="<?php echo U('Detail/detail');?>?id=<?php echo ($vo2['id']); ?>">
							<div class="slide_2">
								<img src="/MeiZu-SunShine/Public/<?php echo ($vo2['pic']); ?>" alt="">
				...
				<div class="row hidden">
					<?php if(is_array($mx)): foreach($mx as $key=>$vo3): ?><div class="col-md-2 slide_1">
						<a href="<?php echo U('Detail/detail');?>?id=<?php echo ($vo3['id']); ?>">
							<div class="slide_2">
								<img src="/MeiZu-SunShine/Public/<?php echo ($vo3['pic']); ?>" alt="">
				...
				<?php if(is_array($config)): foreach($config as $key=>$vo4): ?><div class="col-md-2 slide_1">
						<a href="<?php echo U('Detail/detail');?>?id=<?php echo ($vo4['id']); ?>">
							<div class="slide_2">
								<img src="/MeiZu-SunShine/Public/<?php echo ($vo4['pic']); ?>" alt="">
				...
				<?php if(is_array($hardware)): foreach($hardware as $key=>$vo5): ?><div class="col-md-2 slide_1">
						<a href="<?php echo U('Detail/detail');?>?id=<?php echo ($vo5['id']); ?>">
							<div class="slide_2">
								<img src="/MeiZu-SunShine/Public/<?php echo ($vo5['pic']); ?>" alt="">
