<?php if (!defined('THINK_PATH')) exit();?>		<!-- 引入头部 -->
	...
	<div style="background-color:#F2F2F2">
		<div class="container">
			<div class="row" style="margin:0px;">
				...
				<!--  -->
			<div class="main-02">
				<img class="col-md-12" src="/MeiZu-SunShine/Public/Home/images/164728x8z9qyqxzp84e4j4.png" alt="">
			</div>
			...
			<div class="main-03">
				<p class="main-03-p">
					<span class="main-03-span">
						<img src="/MeiZu-SunShine/Public/Home/images/logo.png" alt="">
					</span>
					<span class="main-03-span">
						兑换商城
					</span>
			...
			<div class="main-04" style="background-color:#ffffff;">
				...
				<?php if(is_array($data)): foreach($data as $key=>$vo): ?><li class="main-05-li">
						<img class="main-05-img" src="/MeiZu-SunShine/Public/<?php echo ($vo['pic']); ?>" alt="">
	...
	$('.main-05-a').click(function(){
		...
		if(c>0){
			...
			console.log(msg);
			// if(msg=='ok'){
			// 	var url="/MeiZu-SunShine/index.php/Home";
