...
<!-- /.navbar-static-side -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       							...
       							地址：<input type="text" name="userName" value="">
                                ...
                                <table class="table">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                                            ...
                                            <td>
                                            <?php echo ($vo['province']); ?> <?php echo ($vo['city']); ?> <?php echo ($vo['county']); ?> <?php echo ($vo['town']); ?> <?php echo ($vo['more']); ?>
                                            </td>
                                            <td>
                                            	<a href="<?php echo U('Adress/edit');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                            	<span>|</span>
                                            	<a href="<?php echo U('Adress/delete');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                            </td>
