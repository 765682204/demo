...
<!-- /.navbar-static-side -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       	    <form>
             管理员：<input type="text" name="adminname" value="">
            ...
            <thead>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                    ...
                    <td><img src="/MeiZu-SunShine/Public/<?php echo empty($vo['pic']) ? 'default.jpg' : $vo['pic'];?>"</td>
                    <td><?php echo ($vo['status']==1?'开启':'禁用'); ?></td>
                    <td>
                    <a href="<?php echo U('Meizuadmin/edit',array('id'=>$vo['id']));?>">修改</a>
                    <span>|</span>
                    <a href="<?php echo U('Meizuadmin/del',array('id'=>$vo['id']));?>">删除</a>
                    <span>|</span>
                    <a href="<?php echo U('Meizuadmin/enable',array('id'=>$vo['id'],'status'=>$vo['status']));?>"><?php echo ($vo['status']==1?'禁用':'开启'); ?></a>
                    <span>|</span>
                    <a href="<?php echo U('Meizuadmin/getgroup',array('id'=>$vo['id']));?>">设置权限组</a>
                    </td>
                </tr><?php endforeach; endif; ?>
            <tr>
                <td colspan="7"><?php echo ($show); ?></td>
            </tr>
            </tbody>
        </table>
    </div>   						
