                                ...
                                <table class="table">
                                    ...
                                    <tbody>
										<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success" >
                                            ...
                                            <td><img src="/MeiZu-SunShine/Public/<?php echo empty($vo['src']) ? 'default.jpg' : $vo['src'];?>" width="100px"/></td>
                                            <td><?php echo ($vo["image"]); ?></td>
                                            <td>
                                            	<a href="<?php echo U('Banner/update');?>?id=<?php echo ($vo["id"]); ?>">修改</a>
                                            	<span>|</span>
                                            	<a href="<?php echo U('Banner/delete');?>?id=<?php echo ($vo["id"]); ?>">删除</a>
