...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">管理员分组列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       	    <form>
             管理组：<input type="text" name="title" value="<?php echo I('get.title');?>" placeholder="请输入要查询的管理组名称">
            ...
            <thead>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                    ...
                    <td>
                    <a href="<?php echo U('Authgroup/edit',array('id'=>$vo['id']));?>">修改</a>
                    <span>|</span>
                    <a href="<?php echo U('Authgroup/del',array('id'=>$vo['id']));?>">删除</a>
                    <span>|</span>
                    <a href="<?php echo U('Authgroup/showedit',array('id'=>$vo['id']));?>">查看权限</a>
                    <span>|</span>
                    <a href="<?php echo U('Authgroup/showgroups',array('id'=>$vo['id']));?>">查看组员</a>
                    </td>
                    </td>
                </tr><?php endforeach; endif; ?>
            <tr>
                <td colspan="4"><?php echo ($show); ?></td>
            </tr>
            </tbody>
        </table>
    </div>   						
